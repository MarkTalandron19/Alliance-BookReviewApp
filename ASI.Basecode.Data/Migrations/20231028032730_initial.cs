    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "ISBN-1", "English", new DateTime(2023, 10, 28, 11, 27, 28, 898, DateTimeKind.Local).AddTicks(9491), "Publisher 1", "Synopsis 1", "Book 1" },
                    { "2", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "ISBN-2", "French", new DateTime(2023, 10, 28, 11, 27, 28, 898, DateTimeKind.Local).AddTicks(9512), "Publisher 2", "Synopsis 2", "Book 2" },
                    { "3", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "ISBN-3", "Spanish", new DateTime(2023, 10, 28, 11, 27, 28, 898, DateTimeKind.Local).AddTicks(9516), "Publisher 3", "Synopsis 3", "Book 3" },
                    { "4", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "ISBN-4", "German", new DateTime(2023, 10, 28, 11, 27, 28, 898, DateTimeKind.Local).AddTicks(9519), "Publisher 4", "Synopsis 4", "Book 4" },
                    { "5", null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, "ISBN-5", "Italian", new DateTime(2023, 10, 28, 11, 27, 28, 898, DateTimeKind.Local).AddTicks(9522), "Publisher 5", "Synopsis 5", "Book 5" }
                });
