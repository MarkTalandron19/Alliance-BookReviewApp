    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "1", "Sample content", new DateTime(2023, 11, 25, 23, 20, 1, 863, DateTimeKind.Local).AddTicks(9991), 4, "test@gmail.com", "test", "test" },
                    { "2", "1", "Wow this is a great book!", new DateTime(2023, 11, 25, 23, 20, 1, 864, DateTimeKind.Local).AddTicks(9), 5, "test2@gmail.com", "Aloysius", "Beronque" },
                    { "3", "1", "Slow pacing, got bored of it immediately.", new DateTime(2023, 11, 25, 23, 20, 1, 864, DateTimeKind.Local).AddTicks(11), 2, "test3@gmail.com", "Karen", "Miller" },
                    { "4", "1", "Very nice Story. Impressive writing by the Author.", new DateTime(2023, 11, 25, 23, 20, 1, 864, DateTimeKind.Local).AddTicks(12), 5, "www@gmail.com", "Aloysius", "Beronque" },
                    { "5", "1", "A good read.", new DateTime(2023, 11, 25, 23, 20, 1, 864, DateTimeKind.Local).AddTicks(14), 5, "qwerty@gmail.com", "Enrique", "Pacudan" },
                    { "6", "1", "Not the best out of everything, but still very good nonetheless. I slightly teared up right before the ending part.", new DateTime(2023, 11, 25, 23, 20, 1, 864, DateTimeKind.Local).AddTicks(16), 4, "abc@gmail.com", "Aaron", "Alcuitas" }
                });
